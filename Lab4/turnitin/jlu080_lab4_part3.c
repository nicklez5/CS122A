...
enum LEDS_State4 {INIT3,shift_left,shift_right} led_state4;
volatile unsigned char current_pattern = 0x01;
...
void part4_tick(){
	...
	switch(led_state4){
		case INIT3:
			led_state4 = shift_left;
			break;
		case shift_left:
			if(current_pattern == 0x80){
				led_state4 = shift_right;
			}else{
				led_state4 = shift_left;
			}
			break;
		case shift_right:
			if(current_pattern == 0x01){
				led_state4 = shift_left;
			}else{
				led_state4 = shift_right;
			}
...
void StartSecPulse(unsigned portBASE_TYPE Priority) {
	xTaskCreate(part1_Task,
	(signed portCHAR *)"part1_Task",
	configMINIMAL_STACK_SIZE,
	NULL,
	Priority,
	NULL );
...
void StartSecPulse4(unsigned portBASE_TYPE Priority){
	xTaskCreate(part4_Task,
	(signed portCHAR *)"part4_Task",
	configMINIMAL_STACK_SIZE,
	NULL,
	Priority,
	NULL );
